  ...
  const modalContent = (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* Controls Layer */}
        <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 sm:p-6 z-10 text-white">
          {/* Top Bar */}
          <motion.div
        ...
        <motion.div
          ref={containerRef}
          className="absolute inset-0 flex items-center justify-center p-4 sm:p-12 pointer-events-auto touch-none"
