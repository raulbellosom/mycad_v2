  ...
  if (!isPlatformAdmin) {
    return (
      <PageLayout.Empty
        ...
        description="Esta sección solo está disponible para administradores de plataforma."
      />
    );
  }
      ...
      <div className="grid gap-4 sm:grid-cols-3 mb-6">
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold">{missingPermissions.length}</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between bg-(--muted)/30 px-3 py-2">
                    ...
                    <Badge variant={allExist ? "success" : "warning"} size="sm">
